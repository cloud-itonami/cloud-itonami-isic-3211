# Operator Quickstart — Manufacture of jewellery and related articles

Shortest path from clone to a verified local dry-run for **ISIC 3211** (`cloud-itonami-isic-3211`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3211.git
cd cloud-itonami-isic-3211
```
...
- Blueprint governor key: `jewellery-workshop-plant-operations-governor`
- Likely source path: `jewellerymfg.governor.cljc`
