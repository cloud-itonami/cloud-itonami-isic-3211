# Business Model: Manufacture of jewellery and related articles
...
## Classification
- Repository: `cloud-itonami-isic-3211` ([github.com/cloud-itonami/cloud-itonami-isic-3211](https://github.com/cloud-itonami/cloud-itonami-isic-3211))
- ISIC Rev.5: `3211` — Manufacture of jewellery and related articles
- Domain: `:jewellery/manufacturing`
- Social impact: :worker-safety :materials-safety :consumer-protection
- Actor: `:jewellery-workshop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :jewellery/manufacturing — who wants
...
One managed tenant (:jewellery/manufacturing):
...
- Do not bypass the `:jewellery-workshop-plant-operations-governor` for production decisions.
