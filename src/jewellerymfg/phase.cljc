(ns jewellerymfg.phase
  "Phase 0->3 staged rollout for the jewellery-workshop plant-
  ...
  consequence (a casting/setting/polishing-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human workshop supervisor's call.
  `jewellerymfg.governor`'s `actuate-equipment-blocked-violations`
...
(defn verdict->disposition
  "Map a Jewellery Workshop Plant Operations Governor verdict to a
